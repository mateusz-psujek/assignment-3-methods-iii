...
```{r}
a <- get_variables(fitted_models[[1]])
b <- get_variables(fitted_models[[2]])
c <- get_variables(fitted_models[[3]])
#it seems there is something wrong with these they all have the same number of factors
```
